    ...
    try:
        ...
        for section in sections:
            ...
            for article in section['articles']:
                ...
                # 只包含中文
                article_html = f'''<div style="margin-bottom:35px;"><p style="font-size:18px;font-weight:bold;color:#273469;margin-bottom:5px;text-decoration:underline;background-color: rgb(255, 251, 0);">{title_zh}</p><p style="font-size:15px;color:#1e2749;line-height:1.6;margin-bottom:8px;">{article['content']}</p></div>'''
